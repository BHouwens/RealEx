...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RegexList = __webpack_require__(196);

	var _TranslatedRegex = __webpack_require__(209);
	...
	var App = exports.App = function App() {
	    return _react2.default.createElement(
	        'div',
	        { className: 'container' },
	        _react2.default.createElement(_RegexList.RegexList, null),
	        _react2.default.createElement(_TranslatedRegex.TranslatedRegex, null)
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.RegexList = undefined;

	var _reactRedux = __webpack_require__(169);

	var _actions = __webpack_require__(197);

	var _regexInputList = __webpack_require__(198);

	function mapStateToProps(state) {
	    var regexList = state.regexList;
	...
	function mapDispatchToProps(dispatch) {
	    return {
	        onListItemChange: function onListItemChange(id, text) {
	            dispatch((0, _actions.changeDescription)(id, text));
	        },
	        onListTypeSelect: function onListTypeSelect(id, type) {
	            dispatch((0, _actions.changeType)(id, type));
	        },
	        onAmountSelect: function onAmountSelect(id, amount) {
	            dispatch((0, _actions.changeAmount)(id, amount));
	        },
	        onAddChunk: function onAddChunk() {
	            dispatch((0, _actions.addChunk)());
	        }
	    };
	}

	var RegexList = exports.RegexList = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_regexInputList.RegexInputList);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.RegexInputList = undefined;

	var _react = __webpack_require__(2);

	var _react2 = _interopRequireDefault(_react);

	var _regexInput = __webpack_require__(199);

	var _addInputButton = __webpack_require__(204);

	__webpack_require__(207);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var RegexInputList = exports.RegexInputList = function RegexInputList(_ref) {
	    var inputs = _ref.inputs;
	    var onListItemChange = _ref.onListItemChange;
	    var onListTypeSelect = _ref.onListTypeSelect;
	    var onAmountSelect = _ref.onAmountSelect;
	    var onAddChunk = _ref.onAddChunk;
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            'h1',
	            null,
	            'I want to match text if it'
	        ),
	        _react2.default.createElement(
	            'ul',
	            null,
	            inputs.map(function (input) {
	                return _react2.default.createElement(_regexInput.RegexInput, {
	                    key: input.id,
	                    value: input.text,
	                    type: input.type,
	                    amount: input.amount,
	                    onAmountChange: function onAmountChange(e) {
	                        return onAmountSelect(input.id, e.target.value);
	                    },
	                    onTypeSelect: function onTypeSelect(e) {
	                        return onListTypeSelect(input.id, e.target.value);
	                    },
	                    onChange: function onChange(e) {
	                        return onListItemChange(input.id, e.target.value);
	                    }
	                });
	            })
	        ),
	        _react2.default.createElement(_addInputButton.AddInputButton, { onClick: onAddChunk })
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RegexInput = exports.RegexInput = function RegexInput(_ref) {
	    var value = _ref.value;
	    var id = _ref.id;
	    var type = _ref.type;
	    var amount = _ref.amount;
	    var onChange = _ref.onChange;
	    var onTypeSelect = _ref.onTypeSelect;
	    var onAmountChange = _ref.onAmountChange;

	    var defaultVal = !type ? 'Select' : type,
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            'select',
	            { className: styleClass, defaultValue: defaultVal, onChange: onTypeSelect },
	            _react2.default.createElement(
	                'option',
	                { value: 'then' },
	                'then'
	        ...
	        _react2.default.createElement(
	            'select',
	            { className: 'amount', defaultValue: amount, onChange: onAmountChange },
	            _react2.default.createElement(
	                'option',
	                { value: 'a' },
	                'a'
	            ...
	            _react2.default.createElement(
	                'option',
	                { value: 'optionally-one' },
	                'optionally one'
	            ),
	            _react2.default.createElement(
	                'option',
	                { value: 'optionally-many' },
	                'optionally many'
	            ),
	            _react2.default.createElement(
	                'option',
	        ...
	        _react2.default.createElement('input', { value: value, className: styleClass + " natural-lang", onChange: onChange })
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js!./input-container.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js!./input-container.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.AddInputButton = undefined;
	...
	var AddInputButton = exports.AddInputButton = function AddInputButton(_ref) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js!./add-input-button.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js!./add-input-button.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js!./container__left.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js!./container__left.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".container__left{\n    width: 0;\n    -webkit-box-flex: 1;\n    -webkit-flex-grow: 1;\n        -ms-flex-positive: 1;\n            flex-grow: 1;\n    -webkit-box-ordinal-group: 2;\n    -webkit-order: 1;\n        -ms-flex-order: 1;\n            order: 1;\n    display: -webkit-box;\n    display: -webkit-flex;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n    -webkit-flex-direction: column;\n        -ms-flex-direction: column;\n            flex-direction: column;\n    -webkit-box-pack: center;\n    -webkit-justify-content: center;\n        -ms-flex-pack: center;\n            justify-content: center;\n}\n\n.container__left ul:before,\n.container__left ul:after{\n    content: ' ';\n    display: table;\n}\n\n.container__left ul:after{\n    clear: both;\n}\n\n.container__left ul{\n    padding: 0;\n    margin-top: 0;\n    zoom: 1;\n}\n\nh1{\n  margin-top: 40px;\n  font-family: 'Open Sans', sans-serif;  \n  font-weight: 700;\n  font-size: calc(20px + 8 * ((100vw - 420px) / 860));\n}\n\n@media screen and (min-width: 1280px){\n\n    h1{\n        font-size: 28px;\n    }\n}\n\n@media screen and (max-width: 420px){\n\n    h1{\n        font-size: 20px;\n    }\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TranslatedRegex = undefined;

	var _reactRedux = __webpack_require__(169);

	var _outputRegex = __webpack_require__(210);
	...
	var TranslatedRegex = exports.TranslatedRegex = (0, _reactRedux.connect)(mapStateToProps)(_outputRegex.OutputRegex);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OutputRegex = exports.OutputRegex = function OutputRegex(_ref) {
	    var inputs = _ref.inputs;
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            'div',
	            { className: 'container__right__output' },
	            concatChunks(inputs)
	        )
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js!./container__right.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js!./container__right.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".container__right{\n    width: 0;\n    -webkit-box-flex: 1;\n    -webkit-flex-grow: 1;\n        -ms-flex-positive: 1;\n            flex-grow: 1;\n    -webkit-box-ordinal-group: 3;\n    -webkit-order: 2;\n        -ms-flex-order: 2;\n            order: 2;\n    -webkit-box-pack: center;\n    -webkit-justify-content: center;\n        -ms-flex-pack: center;\n            justify-content: center;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n    -webkit-flex-direction: column;\n        -ms-flex-direction: column;\n            flex-direction: column;\n}\n.container__right .container__right__output{\n    text-align: center;\n    padding-top: 60px;\n    font-family: 'Open Sans', sans-serif;\n    font-weight: 800;\n    font-size: calc(25px + 5 * ((100vw - 420px) / 860));\n}\n@media screen and (min-width: 1280px){\n    .container__right .container__right__output{\n        font-size: 30px;\n    }\n}\n@media screen and (max-width: 420px){\n    .container__right .container__right__output{\n        font-size: 25px;\n    }\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js!./container.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js!./container.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	function regexList() {
	    ...
	    switch (action.type) {
	        ...
	        case 'ADD_CHUNK':
	            return Object.assign({}, state, {
	                chunks: [].concat(_toConsumableArray(state.chunks), [{
